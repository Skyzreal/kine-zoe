...
var loadAuth2 = function(gapiScript, clientId, scopes) {
...
var loadAuth2WithProps = function(gapiScript, props) {
  return __async(this, null, function* () {
    return new Promise((resolve) => {
      gapiScript.load("auth2", () => {
...
var loadClientAuth2 = function(gapiScript, clientId, scopes) {
  return __async(this, null, function* () {
    return new Promise((resolve) => {
...
var loadGapiInsideDOM = function() {
  return __async(this, null, function* () {
    return new Promise((resolve) => {
      ...
      js.onload = () => __async(null, null, function* () {
        resolve(window.gapi);
      });
    });
  });
